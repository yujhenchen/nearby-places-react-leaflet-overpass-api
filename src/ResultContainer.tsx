...
export default function ResultContainer() {
  return (
    ...
    <section className="fixed flex flex-nowrap w-screen h-48 bottom-2 left-0 backdrop-blur items-center p-4 space-x-4 overflow-x-scroll overflow-y-hidden scrollbar-thin scrollbar-thumb-gray-600">
